...
<?php
// Dec 14, 2014  Use local 'transcoder_data' for the transcoder files.
// Jan 25, 2010
...
*/
$this_dir=dirname(__FILE__); //use php magic constant
$transcoder_dir = "$this_dir/transcoder_data";
